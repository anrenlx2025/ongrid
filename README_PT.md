...
**AMD64**
```bash
wget https://github.com/ongridio/ongrid/releases/download/v0.14.1/ongrid-v0.14.1-linux-amd64.tar.xz
tar -xf ongrid-v0.14.1-linux-amd64.tar.xz && cd ongrid-v0.14.1-linux-amd64
sudo ./install.sh
```

**ARM64**
```bash
wget https://github.com/ongridio/ongrid/releases/download/v0.14.1/ongrid-v0.14.1-linux-arm64.tar.xz
tar -xf ongrid-v0.14.1-linux-arm64.tar.xz && cd ongrid-v0.14.1-linux-arm64
sudo ./install.sh
```
...
```bash
# AMD64
wget https://ongrid.cloud/dl/ongrid-v0.14.1-linux-amd64.tar.xz

# ARM64
wget https://ongrid.cloud/dl/ongrid-v0.14.1-linux-arm64.tar.xz
```
