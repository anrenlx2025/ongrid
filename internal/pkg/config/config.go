...
type EdgeConfig struct {
	...
	// TokenRotationDays is the broker token rotation period in days.
	// At startup, when the token age (derived from the secrets.enc
	// modification time) exceeds this period, a rotation is triggered.
	// Clamped to [30, 365]; 0 = default 90.
	//
	// env: ONGRID_EDGE_TOKEN_ROTATION_DAYS; default 0 (→ 90).
...
func Load() (*Config, error) {
	...
	c.Edge.TokenRotationDays = getEnvInt("ONGRID_EDGE_TOKEN_ROTATION_DAYS", 0)
